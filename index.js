...
imgStart.src = "./image/cute-young-boy-kid-wearing-vest-and-hat-free-png.webp";
...
function createLight(a) {
    ...
    const blurLv = [2, 4];
    const count = a;
    const allDefaultColor = ["white", "white", "white", "white", "white"]
    ...
    for (var i = 0; i < count; i++) {
        ...
        var moveTime = Math.floor(Math.random() * 7) + 4;
        ...
        div.style.height = widthEle * Math.floor(Math.random() * 1 + 1) + "px";
        div.style.width = widthEle + "px";
        div.style.marginLeft = randomLeft + "px"
        div.style.marginTop = randomTop + "px"
        div.style.filter = "blur(" + blurLv[blur] + "px" + ")"
        div.style.animation = "moveLight " + moveTime + "s linear infinite";
